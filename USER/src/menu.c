...
Dlg g_dlg[] =           {
                        ...
                        {DLG_DEBUG_ONE,      "↑: 好卡         ", "↓: 坏卡         ", "←: 备卡         ", "→: 出卡         ", 5},
                        {DLG_DEBUG_TWO,      "↑: 翻卡电机正转 ", "↓: 翻卡电机反转 ", "←: 送卡电机正转 ", "→: 送卡电机反转 ", 5},
...
Dlg g_dlg_fault_code[] = {
                        ...
                        {FAULT_CODE01,       "    号卡机故障  ", "故障码:(01H)    ", "说明: 初始化送卡", "电机不能回位    ", 5},
                        {FAULT_CODE02,       "    号卡机故障  ", "故障码:(02H)    ", "说明: 初始化翻卡", "电机反转不能回位", 5},
                        {FAULT_CODE03,       "    号卡机故障  ", "故障码:(03H)    ", "说明: 初始化翻卡", "电机正转不能回位", 5},
                        {FAULT_CODE04,       "    号卡机故障  ", "故障码:(04H)    ", "说明: 工作时送卡", "电机向前堵转    ", 5},
                        {FAULT_CODE05,       "    号卡机故障  ", "故障码:(05H)    ", "说明: 工作时送卡", "电机向后堵转    ", 5},
                        ...
                        {FAULT_CODE0A,       "    号卡机故障  ", "故障码:(0AH)    ", "说明: 工作时送卡", "电机不转        ", 5},
